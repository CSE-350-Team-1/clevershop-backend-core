...
REQUIRED_ENDPOINT_PERMS = {
    ...
    "/service/add_user_list": ["Manipulate_user"],
    "/service/remove_user_list": ["Manipulate_user"],
    ...
    "/service/add_manager_list": ["Manipulate_manager"],
    "/service/remove_manager_list": ["Manipulate_manager"],
